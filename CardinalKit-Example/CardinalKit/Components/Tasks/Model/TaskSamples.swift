...
enum TaskSamples {
    ...
    */
    ...
    static let sampleCoffeeTask: ORKOrderedTask = {
        ...
        // Coffee Step
        let coffeeScaleAnswerFormat = ORKAnswerFormat.scale(
            withMaximumValue: 5,
            minimumValue: 0,
            defaultValue: 3,
            step: 1,
    ...
    */
    ...
    static let sampleSurveyTask: ORKOrderedTask = {
        ...
        This information will help your doctors keep track of how you feel \
        and how well you are able to do your usual activities. \
        If you are unsure about how to answer a question, \
        please give the best answer you can and make \
        a written comment beside your answer.
        """
        ...
        let booleanQuestionStep = ORKQuestionStep(
            ...
            title: nil,
            question: "In the past four weeks, did you feel limited in the kind of work that you can accomplish?",
